...
int main (int nNumberofArgs,char *argv[])
{
  ...
  double bin_threshold = 0.05; // move this into param file 
  ...
  for (int q = 0; q < int(Basin_Slopes.size()); ++q){
    ...
    pair<double,double> LH_Pair = Basin_Slopes[q].Boomerang(Basin_Slopes[q], Basin_Drainage_Areas[q], junction_string, log_bin_width, SplineResolution, bin_threshold); 
