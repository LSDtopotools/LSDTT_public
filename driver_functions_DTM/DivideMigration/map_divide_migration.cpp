...
// 	string res_ext = "_5m";
  ...
  string acc_ext = "_ACC";
//   string sources_ext = "_CH_dreich_nodeindices_for_Arc";
...
//  vector< int > BasinOutletNodes = JunctionNetwork.ExtractBasinJunctionOrder(target_stream_order, FlowInfo);
  ...
  {
    //int outlet_junction = JunctionNetwork.get_Junction_of_Node(BasinOutletNodes[i_basin],FlowInfo);
