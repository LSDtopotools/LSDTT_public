//=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
//
// Knickpoint detection driver - work in progress
// The knickpoint detection is based on ksn - MChi calculated with the Mudd et al., 2014 method
// It requires parameters for channel extraction, chi-culation and M-chi segmentation (See Mudd et al., 2014)
// The output should be a csv file containing knickpoints information
//
//
//
// Boris
