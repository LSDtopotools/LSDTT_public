...
// Utilities
//
// A program for random small calculation out of rasters.
//
...
int main (int nNumberofArgs,char *argv[])
{
  ...
  {
    cout << "=========================================================" << endl;
    cout << "|| Welcome to the utilities tool!                      ||" << endl;
    cout << "|| This program has a number of options to do  some    ||" << endl;
    cout << "|| stuffs on rasters.                                  ||" << endl;
    cout << "|| This program was developed by Boris from work       ||" << endl;
    cout << "|| Simon M. Mudd at the University of Edinburgh        ||" << endl;
    cout << "|| It is unprobable that someone ever read this btw    ||" << endl;
    cout << "|| If you have a question contact me in Romanian.      ||" << endl;
    cout << "=========================================================" << endl;
  ...
  int_default_map["random_int"] = 2;

  // set default in parameter
  float_default_map["random_float"] = 0.0001;

  // set default methods
  bool_default_map["raster_trimmer"] = false;
  bool_default_map["write hillshade"] = false;
  bool_default_map["write fill"] = false;
  bool_default_map["raster_is_filled"] = false;
  bool_default_map["NO_FILLING"] = false;


  // set default string method
  string_default_map["random_string"] = "yes";
  ...
  if (this_bool_map["write fill"])
  {
    if(this_bool_map["raster_is_filled"]){cout<< "Well, you gave me a filled raster and now you asked me to write a filled rater for you. I'll do it but there is something wrong with you..."<<endl;}
    string fill_fname = OUT_DIR+OUT_ID+"_fill";
