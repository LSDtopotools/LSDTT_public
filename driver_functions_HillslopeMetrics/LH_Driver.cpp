...
int main (int nNumberofArgs,char *argv[])
{
  ...
  //run HFR
  vector< Array2D<float> > HFR_Arrays = FlowInfo.HilltopFlowRouting(FilledDEM, hilltops, slope, aspect, CHT, Surfaces[4], ChannelAndFloodplain, Basin_Raster, prefix, print_paths_switch, thinning, trace_path, basin_filter_switch, Target_Basin_Vector);
