		 ...
		 for(int i = 0; i<n_movern; i++)
		  {
			  ...
			  ChiNetwork_extended.print_channel_details_to_file_full_fitted((path_name+DEM_name+fpt_mc+JunctionName+fpt_ext));
			  cout << "Printing the csv file" << endl;
		   ChiNetwork_extended.print_channel_details_to_file_full_fitted_for_ArcMap((path_name+DEM_name+fpt_mc+JunctionName+fpt_ext));
