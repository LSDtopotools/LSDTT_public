...
int main (int nNumberofArgs,char *argv[])
{
	...
	cout << "\t Area thershold for channe extraction: " << AreaThreshold << endl;
  ...
  string DEM_extension = "bil";
	...
	LSDFlowInfo FlowInfo(boundary_conditions,output_rasters[0]);
	// get the sources
	...
	LSDIndexRaster ChannelSegments = ChanNetwork.SplitChannelAdaptive(FlowInfo, sources, MinReachLength);
